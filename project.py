...
try:
   ...
   queue = sqs.create_queue(QueueName='sm1561-pwtc-project', Attributes={'DelaySeconds': '5'})
   ...
   #create databse
   cursor.execute("drop database if exists ptwc;")

   create_database = """create database ptwc; """
   ...
   create_extension_query = """drop table if exists landmarks;"""
   cursor.execute(create_extension_query)
   connection.commit()
...
(
  gid character varying(15) not null,
